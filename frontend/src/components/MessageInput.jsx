    ...
    <div className="p-4 border-t border-slate-700/50">
      ...
      <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto flex space-x-2 md:space-x-4">
        <input
          ...
          className="flex-1 bg-slate-800/50 border border-slate-700/50 rounded-lg py-2 px-3 md:px-4 text-slate-200 placeholder-slate-400 focus:ring-2 focus:ring-cyan-500 focus:outline-none text-sm md:text-base"
